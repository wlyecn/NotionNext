...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wlye', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '糟老头子', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wlye.space', // 网站地址
